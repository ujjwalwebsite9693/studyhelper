...
export default function ContentCard({ item, bookmarked: initialBookmarked, onBookmarkChange }) {
  ...
  return (
    <div className="glass rounded-xl p-4 hover:border-brand-500/40 transition">
